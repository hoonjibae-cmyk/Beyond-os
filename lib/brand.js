...
// v41-231: 알림톡을 실제로 발송하는 사업자명(카카오 발신프로필 소유 업체).
//
// 리포트에는 쓰지 않습니다. 위 배경대로 학부모에게는 센터 브랜드로만 안내합니다.
// 다만 카카오는 혜택(포인트·상품) 지급/소멸 안내 템플릿에 한해
// "발송 업체명을 본문에 고정값으로 넣으라"고 요구합니다. 그 한 곳에만 씁니다.
export const BRAND_OPERATOR_NAME = '목동유쌤영어학원';

// 로고 옆 보조 표기(공간명). 리포트 상단 배지에 함께 씁니다.
export const BRAND_SPACE_NAME = 'The Place 26';

export const BRAND_CONTACT_PHONE = '031-795-3306';
...
// 리포트 하단 문의 한 줄: "문의: BEYOND 학습집중관리센터 031-795-3306"
