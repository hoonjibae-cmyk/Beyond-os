...
// v41-183: 토큰 수명을 12시간 → 2시간으로 줄였습니다.
// 토큰은 발급 시점의 상태를 담고 있어서 계정을 비활성화해도 만료 전까지 통과합니다.
// 화면이 열려 있는 동안 /api/account-me 로 3분마다 계정 상태를 확인하고 토큰을
// 새로 받아 가므로, 정상 사용자는 로그인이 끊기지 않고 수명만 짧아집니다.
export function createAppSessionToken(user, maxAgeSeconds = 60 * 60 * 2) {
