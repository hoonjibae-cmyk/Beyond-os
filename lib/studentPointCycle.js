 ...
 *   집계 구간도 순점수와 같은 "현재 사이클"(마지막 상품 지급 이후)을 씁니다.
 *   전체 누적으로 상계하면 이미 상품으로 받아간 상점까지 벌점을 깎아주게 되어
 *   지급을 여러 번 받은 학생일수록 징계 단계에 도달하지 않는 문제가 생깁니다.
 *
