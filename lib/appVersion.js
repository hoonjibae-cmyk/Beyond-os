...
export const APP_VERSION = 'v41-98.1';
export const APP_VERSION_NAME = '리포트 학습내용 미입력 문구 제거';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '데일리 리포트에서 차시별 학습 내용 및 특이사항이 없는 경우 「학습 내용 및 특이사항 미입력」 문구를 표시하지 않고 해당 줄 자체를 생략합니다. v41-98.1: 이미 생성된 기존 리포트 링크도 재생성 없이 옛 미입력 문구가 자동으로 숨겨지도록 파서를 보완했습니다.';
