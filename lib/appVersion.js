...
export const APP_VERSION = 'v41-99';
export const APP_VERSION_NAME = '당일 결석자 리포트 생성·발송 제외';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '당일 결석(결석 처리)된 학생은 데일리 리포트 전체 생성 및 전체 발송(발송 가능/확인 필요 포함) 대상에서 제외됩니다. 결석자는 목록에 「당일 결석」 발송 불가 사유로 표시되며, 필요 시 개별 처리만 가능합니다.';
