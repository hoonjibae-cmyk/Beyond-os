...
export const APP_VERSION = 'v41-37';
export const APP_VERSION_NAME = 'Version Badge & UI/UX Cleanup Base';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '앱 화면에 배포 버전 배지를 추가하고, 재배포 시 버전 표기를 이 파일 한 곳에서 관리하도록 정리했습니다. 이후 UI/UX 개선 작업의 기준 버전입니다.';
