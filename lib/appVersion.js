...
export const APP_VERSION = 'v41-54';
export const APP_VERSION_NAME = '모바일 쉬는 시간 HOLD 정렬 수정';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '모바일에서 접힌 "쉬는 시간 키오스크 HOLD" 패널이 혼자 가운데 정렬로 보이던 문제를 수정했습니다. 접힌 상태 헤더를 한 줄(제목 왼쪽 · 펼치기 토글 오른쪽)로 고정해 위 알림센터 등 다른 카드와 정렬을 맞췄습니다.';
