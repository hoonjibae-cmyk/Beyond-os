...
export const APP_VERSION = 'v41-38.1';
export const APP_VERSION_NAME = 'Apple-style UI (Light) · 출결·관리 이력 정돈';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '애플 스타일(라이트) 유지. 출결·관리 이력 탭에서 학생 선택을 화면 최상단 첫 단계로 올려 사용 흐름을 정돈했습니다. 기능·구조·상태 로직은 그대로입니다.';
