...
export const APP_VERSION = 'v41-60';
export const APP_VERSION_NAME = '대화면 대시보드 레이아웃 정리';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '대화면(넓은 모니터)에서 대시보드가 과도하게 늘어나고 우측 패널이 멀리 떨어지거나 잘리던 문제를 정리했습니다. 가운데 작업영역을 상한선까지만 넓히고 전체를 중앙 정렬하도록 그리드를 조정했으며, 1261~1360px 구간의 가로 넘침(우측 패널 잘림)도 함께 해결했습니다.';
