...
export const APP_VERSION = 'v41-85';
export const APP_VERSION_NAME = '주별 시간표 결석일 표시';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '학생 시간표 주별 보기에서도 결석 처리된 날을 보라색으로 강조하고 「🚫 결석」(사유 포함)으로 표기합니다. 결석일에는 차시/외출 칩 대신 결석 표시가 우선됩니다. (v41-84 월별 보기와 동일)';
