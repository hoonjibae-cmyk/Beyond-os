...
export const APP_VERSION = 'v41-51';
export const APP_VERSION_NAME = '결석 처리 학생 알림/관리포커스 자동 제외';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '관리자가 출결상태에서 이미 결석을 처리한 학생은 오늘의 시간표 알림센터와 관리 포커스에서 모든 알림(미입실·출결상태 확인·외출 예정·복귀 확인)이 자동으로 내려갑니다. (v41-50의 쉬는 시간 외출 오알림 제거 포함)';
