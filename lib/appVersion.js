...
export const APP_VERSION = 'v41-93';
export const APP_VERSION_NAME = '순공랭킹 게시용 비공개 표기 변경';
export const APP_VERSION_SUBTITLE = 'The Place 26 · Supabase 저장형 대시보드';
export const APP_VERSION_DESCRIPTION = '순공랭킹 게시용 보드에서 닉네임 공개 미동의 학생의 표기를 XXX에서 ♥♥♥로 변경했습니다. (설정 안내 문구도 함께 갱신)';
